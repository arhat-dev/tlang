...
func TestParseFiles(t *testing.T) {
	...
	template := New("root")
	_, err = template.ParseFiles("testdata/file1.tl", "testdata/file2.tl")
	if err != nil {
...
func TestParseGlob(t *testing.T) {
	...
	template := New("root")
	_, err = template.ParseGlob("testdata/file*.tl")
	if err != nil {
		t.Fatalf("error parsing files: %v", err)
	}
	testExecute(multiExecTests, template, t)
...
func TestParseFS(t *testing.T) {
	...
	{
		template := New("root")
		_, err := template.ParseFS(fs, "file1.tl", "file2.tl")
		if err != nil {
			t.Fatalf("error parsing files: %v", err)
		}
		testExecute(multiExecTests, template, t)
	...
	{
		template := New("root")
		_, err := template.ParseFS(fs, "file*.tl")
		if err != nil {
			t.Fatalf("error parsing files: %v", err)
		}
		testExecute(multiExecTests, template, t)
...
var templateFileExecTests = []execTest{
	{"test", `template "tmpl1.tl"; template "tmpl2.tl"`, "template1\n\ny\ntemplate2\n\nx\n", 0, true},
}

func TestParseFilesWithData(t *testing.T) {
	template, err := New("root").ParseFiles("testdata/tmpl1.tl", "testdata/tmpl2.tl")
	if err != nil {
		t.Fatalf("error parsing files: %v", err)
	}
...
func TestParseGlobWithData(t *testing.T) {
	template, err := New("root").ParseGlob("testdata/tmpl*.tl")
	if err != nil {
		t.Fatalf("error parsing files: %v", err)
	}
	testExecute(templateFileExecTests, template, t)
